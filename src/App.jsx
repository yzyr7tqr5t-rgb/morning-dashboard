  ...
  return (
    <div className={cn(
      ...
      <div className="max-w-lg mx-auto space-y-5">
        ...
        {/* Google search */}
        <form
          onSubmit={e => { e.preventDefault(); const q = e.target.q.value.trim(); if (q) window.open(`https://www.google.com/search?q=${encodeURIComponent(q)}`, '_blank') }}
          className={cn('flex items-center gap-2 rounded-3xl px-4 py-3', isLight ? 'bg-white shadow-sm' : 'bg-white/8 ring-1 ring-white/10')}
        >
          ...
          <input
            ...
            className={cn('flex-1 bg-transparent text-[15px] focus:outline-none placeholder:font-normal', isLight ? 'text-slate-800 placeholder-slate-400' : 'text-white/90 placeholder-white/30')}
          />
        </form>
